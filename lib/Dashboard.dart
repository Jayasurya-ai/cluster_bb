...
floatingActionButton:Padding(
  ...
  child:     StreamBuilder(
    ...
    builder: (context,snapshot){
      ...
      return Text(DateFormat('hh:mm aa').format(DateTime.now()), textAlign: TextAlign.left, style: GoogleFonts.fugazOne(
            textStyle: TextStyle(
              // '10 : 50 AM'
    color: Colors.black,
    fontSize: 23
 ...
 Positioned(
  ...
  Padding(
    ...
    child: Row(
      ...
      RippleAnimation(
        repeat: true,
              color:  _speed<40?CupertinoColors.activeGreen:CupertinoColors.destructiveRed,
              minRadius: 70,
              ripplesCount: 2,
        child:   Column(
          children: [
           ...
           try{
             if(reconnect=true){
               ...
               if (devices.length == 0) {
                 ...
                 devices.forEach((devi) async{

                   if(devi.vid=="60000"||devi.vid==60000) {
                     port = await devi.create();
                 ...
                 print({
                   ...
                   "device_name":devices[0].productName,
                   "man_name":devices[0].manufacturerName,
                 });
                 print("port  found");
